...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Future<void> _handleReset() async {
    ...
    if (email.isEmpty) {
      Get.snackbar('Error', 'Please enter your university email.',
    ...
    try {
      ...
      Get.snackbar('Success', 'Recovery email sent! Check your inbox.',
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'CAMPUS',
                  style: AppTextStyles.headline(24,
                      color: AppColors.primary, italic: true),
                ),
                IconButton(
                  onPressed: () {},
      ...
      children: [
        Text(
          ...
          style: AppTextStyles.label(12,
              color: AppColors.secondary, weight: FontWeight.bold, letterSpacing: 4.0),
        ),
    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: AppTextStyles.label(10,
              color: AppColors.primary, weight: FontWeight.bold, letterSpacing: 2.0),
        ),
                    ...
                    children: [
                      Text(
                        ...
                        style: AppTextStyles.label(14,
                            color: Colors.black, weight: FontWeight.bold, letterSpacing: 2.0),
                      ),
